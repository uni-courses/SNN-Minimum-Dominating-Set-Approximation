...
def perform_generic_neuron_property_asserts(
    pt, test_object, previous_a_in, previouw_u, sample_neuron, tested_neuron
):
    ...
    pt.assertEqual(tested_neuron.v.get(), expected_voltage)

    pt.assertEqual(tested_neuron.du.get(), sample_neuron.du)  # Custom Value.
    pt.assertEqual(tested_neuron.dv.get(), sample_neuron.dv)  # Custom value.
    pt.assertEqual(tested_neuron.bias.get(), sample_neuron.bias)  # Custom value.
    pt.assertEqual(tested_neuron.vth.get(), sample_neuron.vth)  # Default value.
